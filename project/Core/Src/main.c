...
/* Definitions for rPT */
osThreadId_t rPTHandle;
const osThreadAttr_t rPT_attributes = {
  .name = "rPT",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal1,
};
/* Definitions for sPT */
osThreadId_t sPTHandle;
const osThreadAttr_t sPT_attributes = {
  .name = "sPT",
  .stack_size = 128 * 4,
...
//	  int32_t press = baro_read_press();
//
//	  snprintf(text, countof(text), "/*%ld, %ld*/", temp / 100, press / 100);
//	  HAL_UART_Transmit(&huart1, (uint8_t*)text, strnlen(text, countof(text)), HAL_MAX_DELAY);
    /* USER CODE END WHILE */
...
/* USER CODE BEGIN Header_StartRPT */
/**
  * @brief  Function implementing the rPT thread.
...
/* USER CODE BEGIN Header_StartSPT */
/**
* @brief Function implementing the sPT thread.
* @param argument: Not used
* @retval None
*/
