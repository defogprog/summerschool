...
/* Definitions for TaskWrite */
osThreadId_t TaskWriteHandle;
const osThreadAttr_t TaskWrite_attributes = {
  .name = "TaskWrite",
  .stack_size = 128 * 4,
...
/* Definitions for semTrans */
osSemaphoreId_t semTransHandle;
const osSemaphoreAttr_t semTrans_attributes = {
  .name = "semTrans"
};
/* USER CODE BEGIN PV */
char text[100];
...
/**
  * @brief  Function implementing the TaskWrite thread.
